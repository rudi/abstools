...
handle_call(From, {module_for_class, Class}, _State, Data=#data{class_table=Classes}) ->
    {keep_state_and_data, {reply, From, maps:get(Class, Classes, Class)}};
handle_call(From, {update_class_definition, OldClass, NewClass}, _State,
            Data=#data{class_table=Classes,active=Active,idle=Idle,blocked=Blocked}) ->
    ...
    {keep_state, Data#data{class_table=NewClasses#{OldClass => NewClass}},
     {reply, From, ok}};
