...
public enum ErrorMessage {
    ...
    MAIN_BLOCK_RETURN_STMT("A return statement in a main block must return an Integer."),
    ...
    RETURN_STMT_MUST_BE_LAST("Return statements must be the last statement of a method or main block."),
